...
enum class ETLLightType : uint8 {
  ...
  RightTurnAndRightUTurnGreen UMETA(DisplayName =
                                        "Right Turn & Right U-Turn (Green)"),
  RightTurnAndRightUTurnAmber UMETA(DisplayName =
                                        "Right Turn & Right U-Turn (Amber)"),
  RightTurnAndRightUTurnRed UMETA(DisplayName =
                                      "Right Turn & Right U-Turn (Red)"),
  LeftTurnAndLeftUTurnGreen UMETA(DisplayName =
                                      "Left Turn & Left U-Turn (Green)"),
  LeftTurnAndLeftUTurnAmber UMETA(DisplayName =
                                      "Left Turn & Left U-Turn (Amber)"),
