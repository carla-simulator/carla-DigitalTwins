...
void UCustomFileDownloader::ConvertOSMInOpenDrive(FString FilePath, float Lat_0, float Lon_0, double Default_lane_width, double Default_Layer_Height)
{
  ...
  Settings.elevation_layer_height = Default_lane_width;
